					...
					try
						{
							...
							Connection connection1=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/itmd521","root","itmd521");
							...
							maximumTemperature = Integer.parseInt(resultset1.getString(1));
